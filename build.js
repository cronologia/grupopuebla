...
// localized page (the tfp "IPCO (sympathetic source)" defect; here it was
// "Emol (center-right)" and its kin on every Spanish and Portuguese page).
// Adopted from the template (core#74 machinery).
