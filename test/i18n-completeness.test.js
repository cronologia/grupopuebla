...
const PUBLISHER_BRACKET_OK = new Set([
  // "(ES)" / "(EN)" name the language EDITION of Wikipedia — the parenthetical
  // names which encyclopedia, it does not characterise it.
  'wikipedia-es', 'wikipedia-pi',
  // "(Chile)" names WHICH La Nación (the Chilean paper, not the Argentine one).
  'lanacion-aniversario',
  // "(Konrad-Adenauer-Stiftung)" names the parent publisher; the stance prose
  // that used to share the bracket now lives in publisherNote.
  'dialogo-galaxia',
]);
// <<< ADOPT
